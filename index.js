  ...
  sock.ev.on("messages.upsert", async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      ...
      try {
        ...
        // ═══════════════════════════════════
        // 🏫 ABSEN E-PRAKERIN SEKOLAH (DENGAN FOTO)
        // ═══════════════════════════════════
        else if (isAbsenEprakerin) {
          await sock.sendMessage(senderJid, {
            text: `⚠️ *Fitur E-Prakerin Dimatikan*\n\nMaaf bosku, fitur otomatisasi web E-Prakerin (Puppeteer) sudah dimatikan karena masih ada bug.\nSilakan isi absen secara manual langsung di web sekolah ya! 🙏`,
          });
        }

        // ═══════════════════════════════════
        // ✅ JURNAL E-PRAKERIN (WEB SEKOLAH)
        // ═══════════════════════════════════
        else if (isJurnalEprakerin) {
          await sock.sendMessage(senderJid, {
            text: `⚠️ *Fitur E-Prakerin Dimatikan*\n\nMaaf bosku, fitur otomatisasi Jurnal web E-Prakerin (Puppeteer) sudah dimatikan karena masih ada bug.\nSilakan isi jurnal secara manual langsung di web sekolah ya! 🙏`,
          });
        }
